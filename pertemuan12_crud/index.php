<?php
	...
	if(isset($_POST['bsimpan']))
	{
		...
		{	
			...
			{
				echo "<script>alert('Edit data suksess!');document.location='index.php';</script>";
			}
			else
			{
		...
		else
		{
			...
			{
				echo "<script>alert('Simpan data suksess!');document.location='index.php';</script>";
			}
			else
			{
	...
	if(isset($_GET['hal']))
	{
		...
		else if ($_GET['hal'] == "hapus")
		{
			...
			if($hapus){
				echo "<script>alert('Hapus Data Suksess!!');document.location='index.php';</script>";
			}
		}
	}
	    ...
	    <form method="post" action="">
	    	...
	    	<div class="form-group">
	    		...
	    		<select class="form-control" name="tprodi">
					<option value="<?=@$vprodi?>">--Pilih Prodi--</option>
	    	...
	    	<button type="reset" class="btn btn-info" name="breset">Clear</button>
